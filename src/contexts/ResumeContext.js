    ...
    (state, { type, payload }) => {
      ...
      switch (type) {
        ...
        case 'load_demo_data':
          ...
          newState.profile.qrimage = state.profile.qrimage;
          newState.profile.uniqueId = state.profile.uniqueId;
          debouncedUpdateResume(newState);
          return newState;

        case 'add_qr':
          newState = clone(state);
          newState.profile.qrimage = payload.qrdata.qrimage;
          debouncedUpdateResume(newState);
          return newState;

        case 'update_qrfile':
          newState = clone(state);
          newState.profile.filehash = payload.apidata.filehash;
          debouncedUpdateResume(newState);
          return newState;
